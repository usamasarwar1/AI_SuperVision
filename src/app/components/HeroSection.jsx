...
const ServiceItem = ({ index, title, description, icon, active, onClick }) => {
  return (
    ...
    >
      ...
      <div>
        ...
        <p className="text-[#989898] poppins-regular text-[14px]">{description}</p>
      </div>
    </div>
  );
};const HeroSection = () => {
  ...
  return (
    <div>
      <div className="   public-sans min-h-[810px] relative bg-hero-gradient  bg-cover bg-no-repeat bg-center bg-gradient-with-image-hero-section">
          <div className="flex w-full  h-inherit absolute inset-0 bg-gradient-to-b from-transparent to-black opacity-75" style={{minHeight:'inherit'}}>
  ...
  <path d="M32 11.6816L2 11.6816" stroke="#FFFEFE" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/>
  <path d="M24 1.68164L32.5858 10.2674C33.2525 10.9341 33.5858 11.2674 33.5858 11.6816C33.5858 12.0959 33.2525 12.4292 32.5858 13.0959L24 21.6816" stroke="#FFFEFE" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
              </Button>
            </div>
          </div>
