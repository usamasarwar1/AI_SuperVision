          ...
          <div className="col-span-12 sm:col-span-6 lg:col-span-4 poppins-regular">
            ...
            <div className="w-full flex flex-col">
              <Input
                ...
                classNames={{
                  inputWrapper:
                    "bg-[#1b1f23cc] rounded-tr-none rounded-br-none  rounded-[75px] p-[9px_15px] md:px-[24px] md:py-[19px] text-[13px] flex-grow h-[46px] md:h-[60px] border-[1px] mb-[26px] border-[#ffffff1a] text-[#989898] font-normal hover:bg-[#1b1f23cc] focus:bg-red-900",
                }}
              />
              <button
                as={Link}
